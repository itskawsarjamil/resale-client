        ...
        <div>
            <section className="my-8 ">
                ...
                <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
                    <div className="flex flex-col items-center mx-12 lg:mx-0 shadow-lg p-8">
                        <div className="relative text-center">
                            ...
                            <p className="px-6 py-1 text-lg italic">I've experienced Uptot as both a buyer and a seller, and I've been blown away by the level of customer service, attention to detail, and variety of products available. So happy to be able to enjoy shopping while knowing I'm doing my bit to contribute to sustainability!</p>
